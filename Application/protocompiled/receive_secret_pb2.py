...
_RECEIVESECRET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='role', full_name='ReceiveSecret.role', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='active', full_name='ReceiveSecret.active', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='created_on', full_name='ReceiveSecret.created_on', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nonce', full_name='ReceiveSecret.nonce', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nonce_hash', full_name='ReceiveSecret.nonce_hash', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='signed_nonce', full_name='ReceiveSecret.signed_nonce', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='idx', full_name='ReceiveSecret.idx', index=6,
