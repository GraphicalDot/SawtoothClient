...
EXECUTE_SHARE_SECRET = f"{REST_API_URL}/accounts/users/execute_share_secret"
CREATE_RECEIVE_SECRET = f"{REST_API_URL}/accounts/users/create_receive_secret"
GET_ACCOUNT = f"{REST_API_URL}/accounts/users/get_account"
GET_RECEIVE_SECRETS =  f"{REST_API_URL}/accounts/users/get_receive_secrets"
GET_SHARES_ON_RECEIVE_SECRETS =  f"{REST_API_URL}/accounts/users/share_secrets_on_receive_address"
